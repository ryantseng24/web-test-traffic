...
getAgent() {
    ...
    case "$num" in
        ...
        55) 
            ...
            ;; 
        56) 
            agent="Dalvik/2.1.0 (Linux; U; Android 9; ADT-2 Build/PTT5.181126.002)"
            ;; 
        57) 
        ...
        59) 
            ...
            ;;  
        60) 
            agent="Mozilla/5.0 (Linux; Android 9; AFTWMST22 Build/PS7233; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.152 Mobile Safari/537.36"
            ;; 
        61) 
        ...
        65) 
            ...
            ;;  
        66) 
            agent="Mozilla/5.0 (PlayStation; PlayStation 5/2.26) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0 Safari/605.1.15"
            ;; 
        67) 
        ...
        68) 
            ...
            ;;
        69) 
            agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64; Xbox; Xbox Series X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/48.0.2564.82 Safari/537.36 Edge/20.02"
            ;;
        70) 
        ...
        71) 
            ...
            ;;
        72) 
            agent="Mozilla/5.0 (Nintendo Switch; WifiWebAuthApplet) AppleWebKit/601.6 (KHTML, like Gecko) NF/4.0.0.5.10 NintendoBrowser/5.1.0.13343"
            ;;
        73) 
...
cat ${url_list} | while read -r line
do
    for ((j=1;j<=$count;j++))
    do
        user_agent=$(getAgent)
